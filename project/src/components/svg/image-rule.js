...
export default function ImageRule() {
  return (
    <Fragment>
      <svg xmlns={"http://www.w3.org/2000/svg"} width={"304"} height={"270"}>
        ...
        <g fill={"none"} fillRule={"evenodd"}>
          ...
          <g transform={"translate(98 160)"}>
            ...
            <g transform={"translate(12.473 12.421)"}>
              ...
              <path
                ...
                fillRule={"nonzero"}
                d={
                  "M57.179 35.15c-.475-5.997-7.208-5.385-7.208-5.385-2.842-5.01-7.281-1.381-7.281-1.381-3.41-4.911-7.687-.36-7.687-.36-7.373-.796-7.087 5.234-7.087 5.234-.173 1.917 1.04 7.847 1.04 7.847-1.094-3.418-3.467-.581-3.467-.581-2.917 4.502-.721 6.967-.721 6.967 3.947 4.626 12.357 10.18 12.357 10.18 3.046 1.745 1.757 3.3 1.757 3.3l18.42-3.044.424-3.494c2.8-8.472-.547-19.284-.547-19.284z"
                }
              />
            </g>
          </g>
          ...
          <g fill={"#B1B4C5"} transform={"matrix(-1 0 0 1 177 39)"}>
            ...
            <path
              d={
                "M41.963 2.015l8.59 8.728c.716.727.71 1.896-.013 2.616a1.833 1.833 0 01-2.6-.013l-8.59-8.728a1.855 1.855 0 01.013-2.616 1.833 1.833 0 012.6.013z"
              }
            />
            <path
              d={
                "M39.35 19.382l8.59-8.728a1.833 1.833 0 012.6-.013c.723.72.729 1.889.013 2.616l-8.59 8.728a1.833 1.833 0 01-2.6.013 1.855 1.855 0 01-.013-2.616z"
              }
            />
          </g>
          <g
